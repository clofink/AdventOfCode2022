function day11Solution2(data) {
    ...
    let bigDivisor = 1;
    for (let monkey of parsedMonkeys) {
        bigDivisor *= monkey.divisibleBy;
    }    
    ...
    for (t = 0; t < numberOfRounds; t++) {
        for (let n = 0; n < parsedMonkeys.length; n++) {
            ...
            for (let i = 0; i < monkey.items.length; i++) {
                ...
                let itemToThrow = monkey.operation(copyItems.shift()) % bigDivisor;

                // console.log(itemToThrow);
    ...
    console.log(monkeyInspectCounts);
