function day5Solution2(data) {
    ...
    for (let instruction of instructions) {
        ...
        let moveTo = steps[2];
        let movingBoxes = groupContents[moveFrom].slice(-(moveCount));
        groupContents[moveFrom] = groupContents[moveFrom].slice(0, -(moveCount));
        groupContents[moveTo] = groupContents[moveTo].concat(movingBoxes);
    }
